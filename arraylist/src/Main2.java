 ...
 */
 ...
 public class Main2 {
     ...
     public void cetakData() {
         ...
         int mahasiswa_dkv = 0;
         int i = 0;
         for(Mahasiswa Obj:dataMasiswa){
             
             System.out.println((i+1)+"\t"+ Obj.get().nim + "\t"+dataMasiswa.get(i).name+"\t"+dataMasiswa.get(i).jurusan+"\t"+dataMasiswa.get(i).tahun_lahir+"\t\t"+dataMasiswa.get(i).Jenis_Kelamin);
